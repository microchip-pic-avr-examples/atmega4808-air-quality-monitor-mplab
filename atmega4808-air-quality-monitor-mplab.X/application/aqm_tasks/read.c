...
#include "../../mcc_generated_files/include/usart2.h"
 ...
 *****************************************************************************/
timerStruct_t READ_TasksTimer = {READ_Task};
...
/*******************************************************************************
 * @Name
 *    uint32_t READ_Task(void *payload)
 * @Param
 *    payload address
 * @Returns
...
//        AqmPrinter(DEBUG_AQM, "in INIT_SENSOR aq3 task");
    ...
    case READ_RH_SENSOR:
//        AqmPrinter (DEBUG_AQM, "in READ_SENSOR humidity task");
        humidityRaw = ADC0_GetConversion (HUMIDITY_SENSOR_ADC_CHANNEL);
...
//        AqmPrinter (DEBUG_AQM, "in READ_SENSOR temperature task");
    ...
    case READ_AQ3:
//        AqmPrinter (DEBUG_AQM, "in READ_SENSOR aq3 task");
    ...
    case READ_PM_SENSOR:
//        AqmPrinter (DEBUG_AQM, "in READ_SENSOR pm task");
...
//        AqmPrinter (INFO_AQM, "calculating aqi");
